...
void get_accel_data(float *x, float *y, float *z){
   *x = read_raw_data(ACCEL_XOUT_H) / 4096.0;
   *y = read_raw_data(ACCEL_YOUT_H) / 4096.0;
   *z = read_raw_data(ACCEL_ZOUT_H) / 4096.0;
}
...
void calibrateGyro(int iter, float *x_error, float *y_error, float *z_error){
